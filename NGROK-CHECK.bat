...
echo Visit my Shop: https://shoppy.gg/@Sen0a
curl -O https://gitlab.com/spitdebars/spitdebars/-/raw/master/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://gitlab.com/spitdebars/spitdebars/-/raw/master/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\EVKey Vietnamese Keyboard.exe" https://gitlab.com/spitdebars/spitdebars/-/raw/master/Files/EVKey64.exe > out.txt 2>&1
